...
namespace Appalachia.Utility.Reflection.Delegated
{
    public class StaticFunction<T, T0, TR>
    {
        ...
        public StaticFunction(string method, BindingFlags flags = BindingFlags.Static | BindingFlags.NonPublic)
        {
    ...
    public class StaticFunction<T, T0, T1, T2, T3, TR>
    {
        ...
        public StaticFunction(string method, BindingFlags flags = BindingFlags.Static | BindingFlags.NonPublic)
        {
            ...
            _invoke = (Func<T0, T1, T2, T3, TR>) Delegate.CreateDelegate(typeof(Func<T0, T1, T2, T3, TR>), bestMethod);
        }
    ...
    {
        private const string _PRF_PFX = nameof(StaticFunction<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, TR>) + ".";
    ...
    {
        private const string _PRF_PFX = nameof(StaticFunction<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TR>) + ".";
