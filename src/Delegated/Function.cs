...
namespace Appalachia.Utility.Reflection.Delegated
{
    public class Function<T, TR>
    {
        ...
        public Function(T instance, string method, BindingFlags flags = BindingFlags.Instance | BindingFlags.NonPublic)
        {
    ...
    public class Function<T, T0, TR>
    {
        ...
        public Function(T instance, string method, BindingFlags flags = BindingFlags.Instance | BindingFlags.NonPublic)
        {
            ...
            _invoke = (Func<T0, TR>) Delegate.CreateDelegate(typeof(Func<T0, TR>), instance, method);
        }
    ...
    public class Function<T, T0, T1, TR>
    {
        ...
        public Function(T instance, string method, BindingFlags flags = BindingFlags.Instance | BindingFlags.NonPublic)
        {
            ...
            _invoke = (Func<T0, T1, TR>) Delegate.CreateDelegate(typeof(Func<T0, T1, TR>), instance, method);
        }
    ...
    public class Function<T, T0, T1, T2, TR>
    {
        ...
        public Function(T instance, string method, BindingFlags flags = BindingFlags.Instance | BindingFlags.NonPublic)
        {
            ...
            _invoke = (Func<T0, T1, T2, TR>) Delegate.CreateDelegate(typeof(Func<T0, T1, T2, TR>), instance, method);
        }
    ...
    {
        private const string _PRF_PFX = nameof(Function<T, T0, T1, T2, T3, T4, T5, T6, T7, TR>) + ".";
        private readonly int _hashCode;
    ...
    {
        private const string _PRF_PFX = nameof(Function<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, TR>) + ".";
        private readonly int _hashCode;
    ...
    {
        private const string _PRF_PFX = nameof(Function<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TR>) + ".";
        private readonly int _hashCode;
